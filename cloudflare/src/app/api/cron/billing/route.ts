...
const PRICE = {
  workers_ai_requests: { perUnit: 1_000, price: 1.0, units: "1k requests" },
  kv_ops: { perUnit: 1_000_000, price: 0.5, units: "1M ops" },
  d1_queries: { perUnit: 1_000_000, price: 1.0, units: "1M queries" },
  r2_ops: { perUnit: 1_000_000, price: 4.5, units: "1M ops" },
  turnstile_ops: { perUnit: 1_000, price: 0.1, units: "1k ops" },
} as const;
